...
# elementary Icons, improved for GNOME
...
This derivative project improves integration with GNOME and adds additional icons for GNOME-specific applications.
...
To contribute to the elementary-gnome icon set, open a pull request to this repository with your icon(s).
